...
wk.add({
  ...
  { "<leader>fl", ":FzfLua git_commits<CR>", desc = "Git commits", mode = "n" },
  { "<leader>fB", ":FzfLua git_branches<CR>", desc = "Git branches", mode = "n" },
  { "<leader>fw", ":FzfLua live_grep<CR>", desc = "Find word", mode = "n" },
  { "<leader>fb", ":FzfLua buffers<CR>", desc = "Buffers", mode = "n" },
  { "<leader>fs", ":FzfLua lsp_document_symbols<CR>", desc = "LSP document symbols" },
  { "<leader>fS", ":FzfLua lsp_live_workspace_symbols<CR>", desc = "Find LSP symbols" },
  -- Neovim
  { "<leader>n", group = "Neovim", icon = "" },
  { "<leader>nh", ":FzfLua helptags<CR>", desc = "Find help", mode = "n" },
  { "<leader>nt", ":FzfLua colorschemes<CR>", desc = "Themes", mode = "n" },
  ...
  { "gD", ":FzfLua lsp_declarations", desc = "LSP declarations" },
  { "gd", ":FzfLua lsp_definitions<CR>", desc = "LSP definitions" },
  { "gr", ":FzfLua lsp_references<CR>", desc = "LSP references" },
  { "ca", ":FzfLua lsp_code_actions<CR>", desc = "LSP code action" },
